...
public record UpdateChallengeCommand(ChallengeId challengeId, Optional<String> name, Optional<String> description, Optional<Integer> experiencePoints, Optional<Difficulty> difficulty, Optional<ChallengeStatus> status, Optional<List<Tag>> tags) {
}
